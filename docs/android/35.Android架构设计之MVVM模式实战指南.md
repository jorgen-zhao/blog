---
title: Android架构设计之MVVM模式实战指南
date: 2023-11-15 10:30:00
permalink: /pages/androidmvvm/
categories: 
  - Android
tags:
  - 架构设计
...
`ViewModel`类专门用于存储和管理与UI相关的数据，在配置更改（如屏幕旋转）时不会销毁。
...
`LiveData`是一种可观察的数据持有者类，遵循观察者模式。当数据变化时，它会通知观察者（通常是UI组件）。
