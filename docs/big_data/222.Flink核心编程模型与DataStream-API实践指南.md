---
title: Flink核心编程模型与DataStream API实践指南
date: 2023-11-15 14:30:00
permalink: /pages/flink-stream-api/
categories: 
  - big_data
tags:
  - Flink
...
Flink将数据视为持续流动的事件流，用`DataStream` API表示：
...
**解决方案**：使用`allowedLateness`和`sideOutputLateData`：
...
**下一步建议**：
1. 尝试实现复杂事件处理(CEP)应用
2. 探索Flink Table API与SQL
3. 研究Flink在实时数仓中的应用场景
