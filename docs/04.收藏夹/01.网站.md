...
## AI
- [ChatGPT](https://chatgpt.com/) ChatGPT是OpenAI开发的人工智能语言模型，地表最强AI。
- [PicsArt AI Writer](https://picsart.com/ai-writer) 一款由PicsArt开发的人工智能写作助手，能根据提示生成各种网页内容，如广告文案、营销口号、社交媒体简介等
- [NotionAI](https://notion.ai/) 一款集成在Notion工作空间中的智能助理，能根据用户的提示生成或改进文本内容。
- [Jasper](https://jasper.ai/) 一款人工智能平台，能帮助用户快速生成类似人类的博客、广告、邮件等文本内容。
- [Stable Diffusion](https://stable-diffusion.com/) 一种深度学习的文本到图像模型，能根据文本描述生成细致的图像，也可用于其他图像生成任务。
- [neural.love](https://neural.love/) 一款利用人工智能合成、增强图像和视频的工具，能让你的视觉效果更出色。
- [DALL·E 2](https://dalle2.com/) 一种新的人工智能系统，能根据自然语言的描述生成逼真的图像和艺术作品。
- [Illustroke](https://illustroke.com/) 一款能根据文本提示生成矢量插画的AI工具，可选择不同的风格和颜色，下载和编辑SVG文件。
- [Midjourney](https://midjourney.com/) 一种AI支持的营销工具，可以帮助企业识别潜在客户并创建个性化营销活动。
- [Fliki](https://fliki.ai/) 一款能根据文本提示生成短视频的AI工具，可选择不同的主题、音乐、字幕等，下载和分享MP4文件。
- [Synthesia](https://synthesia.io/) 一款能根据文本提示生成人工智能视频的AI工具，可选择不同的演讲者、语言、背景等，制作教育、营销、培训等视频。
- [Otter](https://otter.ai/) 一款能根据语音或视频生成文字记录的AI工具，可提供实时或离线的语音转写、编辑、共享等功能，支持多种语言和场景。
- [Eightify](https://eightify.com/) 一款能根据文本提示生成动画表情包的AI工具，可选择不同的角色、表情、动作等，下载和分享GIF文件。
- [Grammarly](https://www.grammarly.com/) 一款能根据文本内容提供语法、拼写、标点等纠错和改进建议的AI工具，可帮助用户提高写作质量和效率，支持多种语言和平台。
- [Wordtune](https://www.wordtune.com/) 一款能根据文本内容提供不同的表达方式和重写建议的AI工具，可帮助用户改善写作风格和清晰度，支持多种语言和平台。
- [Hemingway](http://www.hemingwayapp.com/) 一款能根据文本内容提供简洁、易读、有力的写作建议的AI工具，可帮助用户避免冗长、复杂、被动的句子，支持多种语言和平台。
...
- [FC在线模拟器(小霸王游戏机)](https://game.Jorgen.com/) 童年回忆
...
- [到账语音生成器](https://zfb.Jorgen.com/) 支付宝到账1亿元
